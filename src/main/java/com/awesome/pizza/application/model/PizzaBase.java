...
@Table
public class PizzaBase implements APAuditModel, LogicalDelete {
	...
	@Override
	public PizzaBase setId(long id) {
		this.id = id;
		return this;
	} // setId
	...
	public PizzaBase setCode(String code) {
		this.code = code;
		return this;
	} // setCode
	...
	public PizzaBase setDescr(String descr) {
		this.descr = descr;
		return this;
	} // setDescr
	...
	@Override
	public PizzaBase setLogDel(Boolean logDel) {
		this.logDel = logDel;
		return this;
	} // setLogDel
	...
	public String toString() {
		...
		builder.append("PizzaBase [id=").append(id).append(", code=").append(code).append(", descr=").append(descr)
				.append(", recVer=").append(recVer).append(", tsi=").append(tsi).append(", tsu=").append(tsu)
				.append(", logDel=").append(logDel).append("]");
